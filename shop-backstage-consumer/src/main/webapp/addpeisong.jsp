...
<form id="add_shop_form" method="post">
    <table border="0">
        ...
        <tr>
            <td>首重量<td>
            <td><input class="easyui-textbox" name="firstWeight"><td>
        </tr>
        <tr>
            <td>续重量<td>
            <td><input class="easyui-textbox" name="continueWeight"><td>
        </tr>
        <tr>
            <td>首重价格<td>
            <td><input class="easyui-textbox" name="firstPrice"><td>
        </tr>
        <tr>
            <td>续重价格<td>
            <td><input class="easyui-textbox" name="continuePrice"><td>
        </tr>
        <tr>
            <td>图标<td>
            <td><input  type="file"   id="file_upload" >
                ...
                <input id="pro_img"  name="icon" type="hidden" /><td>
        </tr>
        <tr>
            <td>排序<td>
            <td><input class="easyui-textbox" name="orders"><td>
        </tr>
       <tr>
            <td>介绍<td>
